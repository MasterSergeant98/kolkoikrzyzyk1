...
function checkWinner()
{
	if(!isResult)
	{
		if(content[1] == 'x' && content[2] == 'x' && content[3] == 'x') showWinner('Wygrywasz!')
		else if(content[4] == 'x' && content[5] == 'x' && content[6] == 'x') showWinner('Wygrywasz!')
		else if(content[7] == 'x' && content[8] == 'x' && content[9] == 'x') showWinner('Wygrywasz!')
		else if(content[1] == 'x' && content[4] == 'x' && content[7] == 'x') showWinner('Wygrywasz!')
		else if(content[2] == 'x' && content[5] == 'x' && content[8] == 'x') showWinner('Wygrywasz!')
		else if(content[3] == 'x' && content[6] == 'x' && content[9] == 'x') showWinner('Wygrywasz!')
		else if(content[1] == 'x' && content[5] == 'x' && content[9] == 'x') showWinner('Wygrywasz!')
		else if(content[3] == 'x' && content[5] == 'x' && content[7] == 'x') showWinner('Wygrywasz!')

		else if(content[1] == '0' && content[2] == '0' && content[3] == '0') showWinner('Przegrywasz!')
		else if(content[4] == '0' && content[5] == '0' && content[6] == '0') showWinner('Przegrywasz!')
		else if(content[7] == '0' && content[8] == '0' && content[9] == '0') showWinner('Przegrywasz!')
		else if(content[1] == '0' && content[4] == '0' && content[7] == '0') showWinner('Przegrywasz!')
		else if(content[2] == '0' && content[5] == '0' && content[8] == '0') showWinner('Przegrywasz!')
		else if(content[3] == '0' && content[6] == '0' && content[9] == '0') showWinner('Przegrywasz!')
		else if(content[1] == '0' && content[5] == '0' && content[9] == '0') showWinner('Przegrywasz!')
		else if(content[3] == '0' && content[5] == '0' && content[7] == '0') showWinner('Przegrywasz!')
